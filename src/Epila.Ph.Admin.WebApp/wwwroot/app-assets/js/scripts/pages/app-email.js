...
$(function () {
    ...
    email_app_list.find('.email-user-list li').on('click', function () {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                console.log("loading...");
                $("#email-app-details").html(`<div class="text-center pt-2">
            ...
            success: function (html) {
                ...
                $("#email-app-details").html("loading --");
                $("#email-app-details").html(html);
            },
            error: function (jqXhr, textStatus, errorThrown) {
                console.log(jqXhr);
                $("#email-app-details").html(`<p class="font-large-1 text-center p-2 text-danger" > <i class="bx bx-error font-large-1"></i>  Failed to get from resource!</p>`);
            }
        });
